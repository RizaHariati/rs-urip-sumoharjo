...
describe("Patient Data", () => {
  ...
  // it("it should show warning alert if account is not found", function () {
  ...
  // it("it should show success alert if account is not found", function () {
  ...
  it("it should show alert", function () {
...
// register warning if not all fields are filled out
// register alert if the account already exist
// register succes if the registration succestful
// register alert if not all field is fillout show loading when fetching data
